...
def main():
        ...
        if single_player:
            ...
            while not question_answered and attempts < 2:
                ...
                if attempts == 1 and buzzer_key == first_buzzer:
                    print(f"{players[buzzer_key]['name']
                             } already attempted this question.")
                    continue
                ...
                if user_answer == correct_answer:
                    ...
                    if attempts == 1:
                        ...
                        print(
                            f"Correct! Steal successful. +1 point to {buzzing_player['name']}")
                    question_answered = True
                else:
                    if attempts == 1:
    ...
    for rank, (key, player) in enumerate(sorted_players, 1):
        ...
        print(f"{rank}. {player['name']}: {
              player['score']}/{len(QUESTIONS)} ({percentage:.1f}%)")
